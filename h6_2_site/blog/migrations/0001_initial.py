...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('nid', models.AutoField(primary_key=True, serialize=False)),
                ('article_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='blog.Article', verbose_name='文章')),
            ],
        ),
        migrations.CreateModel(
            name='ArticleUpDown',
        ...
        migrations.AddField(
            model_name='blog',
            name='site_style',
            field=models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='blog.BlogStyle'),
        ),
        migrations.AddField(
